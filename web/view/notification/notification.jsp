        ...
        <div id="w">
            <div id="content" style="margin-top: 100px">
                ...
                <div class="notify successbox" style="text-align: center;">
                    ...
                    <a href="http://localhost:8080/onlinelearn/home"><button type="button" class="btn btn-primary" style="background: #0e4bf1; margin-top: 30px">Quay trở lại trang chủ</button></a>
                </div>
